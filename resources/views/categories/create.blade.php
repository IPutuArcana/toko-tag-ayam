                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('categories.store') }}" method="POST">
                        ...
                        <div>
                            ...
                            <input type_text="text" name="name" id="name" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('name') }}" required autofocus>
                        </div>
