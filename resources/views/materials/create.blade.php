                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('materials.store') }}" method="POST">
                        ...
                        <div>
                            ...
                            <input type_text="text" name="name" id="name" class="block mt-1 w-full rounded-md shadow-sm border-gray-300" value="{{ old('name') }}" required>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <input type_text="text" name="unit" id="unit" class="block mt-1 w-full rounded-md shadow-sm border-gray-300" value="{{ old('unit') }}" placeholder="Contoh: lembar, pcs, meter" required>
                        </div>

                        <div class="mt-4">
                            <label for="cost_price" class="block font-medium text-sm text-gray-700">Harga Modal (per Unit)</label>
                            <input type_text="number" name="cost_price" id="cost_price" class="block mt-1 w-full rounded-md shadow-sm border-gray-300" value="{{ old('cost_price', 0) }}" step="0.01" required>
                        </div>
